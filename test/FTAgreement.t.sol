...
// import {FTAgreement} from "../src/agreements/FTAgreement.sol";
// import {MockToken} from "src/mocks/MockToken.sol";
// import {IGovernor} from "@openzeppelin/contracts/governance/IGovernor.sol";
// import {IAgreement} from "../src/interfaces/IAgreement.sol";
// import {Vm} from "forge-std/Vm.sol";

// contract FTAgreementTest is Test {
...
//     address public ftAgreementImplementation;
...
//         // FTAgreement implementations
//         ftAgreementImplementation = address(new FTAgreement());
//     }

//     function _initializeLendingPool() internal {
//         address[] memory supportedAgreements = new address[](1);
//         supportedAgreements[0] = ftAgreementImplementation;
...
//         require(stormbitLending.isSupportedAgreement(ftAgreementImplementation));
...
//     function testRequestFTLoanE2EMinimalChecks() public {
//         _initializeLendingPool();
